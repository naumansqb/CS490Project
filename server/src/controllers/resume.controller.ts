...
async function getUserProfileData(userId: string) {
    try {
        ...
        console.log('📋 PROFILE DATA FETCHED:', JSON.stringify(profile, null, 2));
        ...
        console.log('💼 WORK EXPERIENCE FETCHED:', JSON.stringify(workExperience, null, 2));
        ...
        console.log('🎓 EDUCATION FETCHED:', JSON.stringify(education, null, 2));
...
function getTemplateContent(templateType: string, userData: any) {
    ...
    console.log('🎨 Template Type:', lower);
...
You can use 4-8 statements.`;
    ...
    if (lower.includes('function')) {
        ...
        console.log('📦 Grouped Skills:', JSON.stringify(groupedSkills, null, 2));
        ...
        console.log('✅ Skill Categories for Functional:', JSON.stringify(skillCategories, null, 2));
    ...
    if (lower.includes('hybrid')) {
        ...
        console.log('✅ Skill Categories for Hybrid:', JSON.stringify(skillCategories, null, 2));
...
export async function getResumesByAuthUser(req: Request, res: Response) {
    try {
        ...
        console.error('Error fetching resumes by auth user:', err);
...
export async function createResume(req: Request, res: Response) {
    try {
        ...
        console.log('📄 FINAL CONTENT:', JSON.stringify(baseContent, null, 2));
...
export async function getResumesByUserId(req: Request, res: Response) {
    try {
